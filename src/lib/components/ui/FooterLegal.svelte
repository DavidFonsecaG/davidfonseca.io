...
<div
  class="flex flex-col md:flex-row gap-8 pt-8 border-t border-muted-foreground/50 text-muted-foreground text-sm tracking-tighter md:justify-between"
>
  {#if showCopyrights}
  ...
  <div class="flex gap-3">
    <a
      href="https://linkedin.com/in/david-fonseca2"
