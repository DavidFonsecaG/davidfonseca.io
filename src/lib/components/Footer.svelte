...
<div class="w-full">
  <footer class="w-full p-2">
    <div
      class="flex w-full bg-primary rounded-2xl md:rounded-3xl items-center justify-center"
    >
      <div
        class="flex flex-col w-full p-8 md:6 md:pt-12 bg-primary rounded-3xl space-between font-normal gap-10 md:max-w-15/16"
      >
        <div
          class="flex flex-col text-card gap-10 md:flex-row md:justify-between"
        >
          <div class="flex flex-col w-full gap-5">
            <div>
              <a class="flex text-card gap-3 items-center" href="/">
                ...
                <h4 class="text-lg tracking-tight leading-none font-bold">
                  David Fonseca
                </h4>
              </a>
            </div>
          ...
          <div class="flex flex-col w-full gap-3 text-sm">
            ...
            <div class="flex flex-col gap-2">
              ...
              <div>
                <a class="hover:text-blue-500" href="/projects">Projects</a>
              </div>
              <div>
                <a class="hover:text-blue-500" href="/contact">Contact Me</a>
              </div>
            </div>
          </div>
        </div>
