...
<div class="flex flex-col items-center justify-center text-center px-4 pt-5 pb-10 md:px-6 md:pb-30 w-full md:max-w-15/16 gap-20 ">
    ...
    <Card variant="default" className={"px-8 gap-20 w-full md:px-16 md:py-18"}>
        <CardContent className="flex flex-col w-full gap-5 text-start">
    ...
    <Card variant="secondary" className={"px-8 gap-20 md:px-16 md:py-18"}>
        <CardContent className="flex flex-col gap-5">
            <div class="flex flex-col w-full text-start gap-4">
                <CardTitle className={"text-2xl md:text-3xl "}><h2>Applications</h2></CardTitle>
            ...
            <div class="flex grid md:grid-cols-2 gap-7 w-full text-card">
                ...
                <Card variant="pastel" className={"h-40 p-6 md:p-8 items-center justify-center shadow transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-101 hover:shadow-lg"}>
        ...
        <div class="flex flex-wrap justify-center m-2">
            <a href="https://github.com/DavidFonsecaG" class="inline-flex items-center justify-center gap-2 bg-transparent hover:text-blue-500 text-muted-foreground text-lg">
