...
<div class="flex flex-col items-center justify-center text-center px-4 pt-12 pb-10 md:px-6 md:pb-30 w-full md:max-w-15/16 gap-16">

    <Card variant="default" className={"flex md:flex-row px-8 w-full gap-5 md:px-16 md:py-18"}> 
        <CardContent className="flex flex-col md:w-3/5 justify-start text-start gap-5">
    ...
    <Card variant="secondary" className={"px-8 gap-14 md:gap-20 md:px-16 md:py-18"}>
        ...
        <div class="flex flex-wrap justify-center m-2">
            <a href="https://github.com/DavidFonsecaG" class="flex items-center justify-center gap-2 bg-transparent hover:text-blue-500 text-muted-foreground text-sm md:text-lg" target="_blank">
                <svg class="w-5 h-5" viewBox="0 0 16 16" xmlns="https://www.w3.org/2000/svg" fill="currentColor">
